...
RUN apt install mercurial wget autoconf build-essential zip unzip libx11-dev libxext-dev libxrender-dev libxrandr-dev libxtst-dev libxt-dev libcups2-dev libfontconfig1-dev libasound2-dev -y
...
RUN tar xvf openjdk-13+33_linux-x64_bin.tar.gz

RUN tar xvf jtreg-5.0-b01.tar.gz

RUN rm -fR tip.tar.bz2 openjdk-13+33_linux-x64_bin.tar.gz jtreg-5.0-b01.tar.gz
